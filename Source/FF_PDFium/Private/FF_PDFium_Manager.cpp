...
void UPDFiumSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UPDFiumSubsystem::Deinitialize()
{
	if (this->bIsLibInitialized)
	{
		FPDF_DestroyLibrary();
...
bool UPDFiumSubsystem::IsLibInitialized() const
{
	return this->bIsLibInitialized;
}

// Sets default values.
APDF_Manager::APDF_Manager()
{
	PrimaryActorTick.bCanEverTick = true;
}

// Called when the game starts or when spawned.
void APDF_Manager::BeginPlay()
{
	UPDFiumSubsystem* Subsystem = GEngine->GetEngineSubsystem<UPDFiumSubsystem>();
	APDF_Manager::bIsLibInitialized = Subsystem->IsLibInitialized();

	Super::BeginPlay();
}

// Called when the game end or when destroyed.
void APDF_Manager::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
// Called every frame.
void APDF_Manager::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

TArray64<uint8> APDF_Manager::SaveBytes64(bool& bIsSaveSuccessful, EPDFiumSaveTypes In_SaveType, EPDFiumSaveVersion In_Version)
{
...
TArray<uint8> APDF_Manager::SaveBytes(bool& bIsSaveSuccessful, EPDFiumSaveTypes In_SaveType, EPDFiumSaveVersion In_Version)
{
...
bool APDF_Manager::PDFium_Doc_Open_File(FString& ErrorCode, FString In_Path, FString In_PDF_Password)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
	...
	this->Document = MoveTemp(Temp_Document);

	ErrorCode = "Success.";
	return true;
}

bool APDF_Manager::PDFium_Doc_Open_Memory_x64(FString& ErrorCode, UPARAM(ref)UBytesObject_64*& In_Bytes_Object, FString In_PDF_Password)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
	...
	const size_t Data_Size = In_Bytes_Object->ByteArray.Num();

	TArray64<uint8> Temp_Bytes;
	Temp_Bytes.SetNumUninitialized(Data_Size);
	FMemory::Memcpy(Temp_Bytes.GetData(), In_Bytes_Object->ByteArray.GetData(), Data_Size);

	FPDF_DOCUMENT Temp_Document = FPDF_LoadMemDocument64(Temp_Bytes.GetData(), Temp_Bytes.Num(), TCHAR_TO_UTF8(*In_PDF_Password));
	...
	FPDF_LoadXFA(Temp_Document);
	this->Document = MoveTemp(Temp_Document);
	this->PDF_Bytes_x64 = MoveTemp(Temp_Bytes);
...
bool APDF_Manager::PDFium_Doc_Open_Memory_x86(FString& ErrorCode, TArray<uint8> In_Bytes, FString In_PDF_Password)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
	...
	const size_t Data_Size = In_Bytes.Num();

	TArray64<uint8> Temp_Bytes;
	Temp_Bytes.SetNumUninitialized(Data_Size);
	FMemory::Memcpy(Temp_Bytes.GetData(), In_Bytes.GetData(), Data_Size);
...
bool APDF_Manager::PDFium_Create_Doc()
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Clear_Doc()
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Get_Images(TMap<UTexture2D*, FVector2D>& Out_Images, int32 PageIndex, bool bUseSrgb)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Get_All_Texts(TArray<FString>& Out_Texts)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Get_Texts(TArray<FPdfTextObject>& Out_Texts, int32 PageIndex)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Get_Links(TArray<FString>& Out_Links, int32 PageIndex)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Select_Text(FString& Out_Text, FVector2D Start, FVector2D End, int32 PageIndex)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Pages_Counts_Sizes(TArray<FVector2D>& Out_Infos)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Pages_Add(TArray<FVector2D> Pages)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Pages_Delete(int32 PageIndex)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Font_Load_Standart(UPDFiumFont*& Out_Font, EStandartFonts Font_Name)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Font_Load_External(UPDFiumFont*& Out_Font, FString Font_Path, EExternalFonts In_Font_Type, bool bIsCid)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
void APDF_Manager::PDFium_Add_Texts(FDelegatePdfium DelegateAddObject, UPARAM(ref)UPDFiumFont*& In_Font, FString In_Texts, FColor Text_Color, FVector2D Position, FVector2D Size, FVector2D Rotation, FVector2D Border, int32 FontSize, int32 PageIndex, bool bUseCharcodes)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
...
bool APDF_Manager::PDFium_Draw_Rectangle(FVector2D Position, FVector2D Anchor, FVector2D Size, FVector2D Rotation, FColor Color, int32 PageIndex)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Add_Image(FString& Out_Code, TArray<uint8> In_Bytes, FVector2D In_Size, FVector2D Position, FVector2D Rotation, int32 PageIndex)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
void APDF_Manager::PDFium_Save_File(FDelegatePdfium DelegateSave, FString Export_Path, EPDFiumSaveTypes In_SaveType, EPDFiumSaveVersion In_Version)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
...
bool APDF_Manager::PDFium_Save_Bytes_x64(UBytesObject_64*& Out_Bytes, EPDFiumSaveTypes In_SaveType, EPDFiumSaveVersion In_Version)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
...
bool APDF_Manager::PDFium_Save_Bytes_x86(TArray<uint8>& Out_Bytes, EPDFiumSaveTypes In_SaveType, EPDFiumSaveVersion In_Version)
{
	if (!APDF_Manager::bIsLibInitialized)
	{
		return false;
